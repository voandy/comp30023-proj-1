OBJS	= image_tagger.o send_page.o handle_http_request.o
HEADER	= src/image_tagger.h src/send_page.h src/handle_http_request.h
OUT	= image_tagger
CC	 = gcc
FLAGS	 = -c -Wall -Wpedantic -g

all: mkbin $(OBJS)
	$(CC) -g bin/image_tagger.o bin/send_page.o bin/handle_http_request.o -o $(OUT)
